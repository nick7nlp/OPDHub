...
The sample weighting problem motivates a more principled solution, namely \emph{curriculum design} that actively selects prompts matching the student's current competence level.
