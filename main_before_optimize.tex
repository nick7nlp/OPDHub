...
\begin{table*}[tbp]
    ...
    \begin{tabular}{@{}lclllll@{}}
        ...
        AKL \citep{2410.14425}            & 2024 & Token  & Adaptive KL         & White-box & Uncertainty-weighted & Dynamic penalty scaling \\
        Contrastive \citep{2403.14608}    & 2024 & Token  & Contrastive Margin  & White-box & Pos./Neg. Paths      & Anti-hallucination training \\
        DSKD \citep{2502.12018}           & 2025 & Token  & Logit + Hidden      & White-box & Dual-Space Matching  & Geometric feature transfer \\
...
\textbf{Problem Definition and Importance.} While the Chinchilla scaling laws rigorously define the optimal parameter-to-dataset-size ratio for pretraining, no such equivalent exists for On-Policy Distillation. Practitioners currently guess the optimal generation budget relative to student size. Understanding how distillation loss scales with student parameters $N_S$, teacher parameters $N_T$, and the number of on-policy generated tokens $D_{\text{on}}$ is vital for optimal compute allocation.
...
\subsection{Practical Guidelines and Decision Matrix}
