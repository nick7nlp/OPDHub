...
\begin{forest}
  ...
  [\textbf{On-Policy}\\\textbf{Distillation}, rbox, text width=2.0cm
    %% ===== Stage 1: Objective =====
    [{\S 4 Objective}, catObj, edge={draw=tgcolor!60, line width=1.2pt}
      [{\textbf{4.1 Fixed Divergence}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{4};}\\[2pt]%
        GKD~\citep{2306.13649}, MiniLLM~\citep{2306.08543}, DistiLLM~\citep{2402.03898}, DistiLLM-2~\citep{2503.07067}%
        }, leaf=tgcolor, edge={draw=tgcolor!30}]
      [{\textbf{4.2 Adaptive Divergence}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{3};}\\[2pt]%
        ToDi~\citep{2505.16297}, AKL~\citep{2404.02657}, Entropy-Aware~\citep{2603.07079}%
        }, leaf=tgcolor, edge={draw=tgcolor!30}]
      [{\textbf{4.3 RL-Augmented}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{5};}\\[2pt]%
        G-OPD~\citep{2602.12125}, KDRL~\citep{2506.02208}, RLAD~\citep{2602.22495},\\[1pt]
        SuperCorrect~\citep{2410.09008}, $\mathcal{X}$-KD~\citep{2602.12674}%
        }, leaf=tgcolor, edge={draw=tgcolor!30}]
    ]
    %% ===== Stage 2: Signal Source =====
    [{\S 5 Signal Source}, catSig, edge={draw=sdcolor!60, line width=1.2pt}
      [{\textbf{5.1 White-Box Logits}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{4};}\\[2pt]%
        DSKD~\citep{2504.11426}, Delta-KD~\citep{2505.16297}, Cross-Tok.\ KD~\citep{2402.12030}, TAID~\citep{2501.16937}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.2 Black-Box / API}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{5};}\\[2pt]%
        GAD~\citep{2511.10643}, Lion~\citep{2305.12870}, OVD~\citep{2601.21968}, DAIL~\citep{2602.02405}, ORPO-Distill~\citep{2509.25100}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.3 Self-Distillation}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{8};}\\[2pt]%
        OPSD~\citep{2601.18734}, SPIN~\citep{2401.01335}, SD-ZERO~\citep{he2026selfdistillation}, $\pi$-Play~\citep{zhang2026piplay},\\[1pt]%
        OPSDL~\citep{2604.17535}, CaOPD~\citep{2604.16830}, SDFT~\citep{2601.19897}, OPCD~\citep{2602.12275}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
    ]
    %% ===== Stage 3: Dynamics =====
    [{\S 6 Dynamics}, catDyn, edge={draw=dycolor!60, line width=1.2pt}
      [{\textbf{6.1 Token/Sample Weighting}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{5};}\\[2pt]%
        TIP~\citep{xu2026tip}, SCOPE~\citep{zheng2026scope}, SelecTKD~\citep{2510.24021},\\[1pt]%
        AdaKD~\citep{2510.11615}, PromptKD~\citep{2402.12842}%
        }, leaf=dycolor, edge={draw=dycolor!30}]
      [{\textbf{6.2 Curriculum \& Stability}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{4};}\\[2pt]%
        PACED~\citep{2603.11178}, AdaSwitch~\citep{2510.07842}, Stable-OPD~\citep{luo2026demystifying}, CSD~\citep{2509.25837}%
        }, leaf=dycolor, edge={draw=dycolor!30}]
      [{\textbf{6.3 Compute Efficiency}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{3};}\\[2pt]%
        Fast OPD~\citep{2602.15260}, Lightning OPD~\citep{wu2026lightning}, Spec.KD~\citep{2602.12222}%
        }, leaf=dycolor, edge={draw=dycolor!30}]
    ]
  ]
\end{forest}
}
\caption{Taxonomy of On-Policy Distillation methods organized by the practitioner's decision chain: (1) Objective function design (\S\ref{sec:objectives}), (2) Signal source selection (\S\ref{sec:signal}), and (3) Training dynamics stabilization (\S\ref{sec:dynamics}). Bracketed numbers indicate the total methods cited in each leaf node.}
\label{fig:taxonomy}
\end{figure*}
