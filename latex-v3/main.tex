  ...
  [\textbf{On-Policy}\\\textbf{Distillation}, rbox, text width=2.0cm
    ...
    [{\S 5 Signal Source and\\Teacher Architecture}, catSig, edge={draw=sdcolor!60, line width=1.2pt}
      ...
      [{\textbf{5.2 Black-Box and API-Constrained Distillation}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{9};}\\[2pt]%
        ...
        ThinkTuning~\citep{rrv2025thinktuning}, DASD~\citep{2601.09088}, DDT~\citep{2602.12222}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.3 Self-Distillation: Privileged Information}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{9};}\\[2pt]%
        ...
        CRISP~\citep{2603.05433}, OPSDL~\citep{2604.17535}, GUI-SD~\citep{zhang2026guisd}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.4 Self-Distillation: Self-Play}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{7};}\\[2pt]%
        ...
        On-Policy SFT~\citep{zhao2026onpolicy}, SSD~\citep{zhang2026embarrassingly}, $\pi$-Play~\citep{zhang2026piplay},\\[1pt]%
        IRIS~\citep{2604.20933}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.5 Self-Distillation: External Feedback}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{7};}\\[2pt]%
        ...
        SRPO~\citep{li2026unifying}, RLTF~\citep{song2026expanding}, CoPD~\citep{gu2026copd},\\[1pt]%
        MSD~\citep{qin2026msd}%
        }, leaf=sdcolor, edge={draw=sdcolor!30}]
    ]
...
\begin{table*}[t]
    ...
    \begin{tabular}{@{}lllll@{}}
        ...
        GUI-SD \citep{zhang2026guisd} & Self (visual PI) & Qwen3-VL-Inst-8B & Entropy-guided KL & ScreenSpot, RefExp, VisGround \\
