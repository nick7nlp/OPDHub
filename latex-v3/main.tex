...
\begin{forest}
  ...
  [\textbf{On-Policy Distillation}, rbox, text width=2.0cm
    ...
    [{\S 4 Objective Functions and Optimization}, catObj, edge={draw=tgcolor!60, line width=1.2pt}
      [{\textbf{4.1 Fixed Divergence Objectives}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{5};} GKD~\citep{2306.13649}, MiniLLM~\citep{2306.08543}, DistiLLM~\citep{2402.03898}, DistiLLM-2~\citep{2503.07067}, KETCHUP~\citep{2504.19024}}, leaf=tgcolor, edge={draw=tgcolor!30}]
      [{\textbf{4.2 Adaptive Divergence Objectives}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{3};} ToDi~\citep{2505.16297}, AKL~\citep{2404.02657}, Entropy-Aware OPD~\citep{2603.07079}}, leaf=tgcolor, edge={draw=tgcolor!30}]
      [{\textbf{4.3 RL-Augmented Objectives}~{\tikz[baseline=-0.5ex]\node[badge=tgcolor]{11};} G-OPD~\citep{2602.12125}, RLKD~\citep{2505.16142}, KDRL~\citep{2506.02208}, RLAD~\citep{2602.22495}, SuperCorrect~\citep{2410.09008}, SCoRe~\citep{2509.14257}, AlignDistil~\citep{2503.02832}, $\mathcal{X}$-KD~\citep{2602.12674}, TSD-KD~\citep{2603.13260}, REOPOLD~\citep{2603.11137}, Constrained~\citep{2509.22921}}, leaf=tgcolor, edge={draw=tgcolor!30}]
    ]
    ...
    [{\S 5 Signal Source and Teacher Architecture}, catSig, edge={draw=sdcolor!60, line width=1.2pt}
      [{\textbf{5.1 White-Box Logit Supervision}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{10};} DSKD~\citep{2504.11426}, Cross-Tokenizer KD~\citep{2402.12030}, TAID~\citep{2501.16937}, Delta-KD~\citep{2509.14526}, Veto~\citep{2601.07155}, PromptKD~\citep{2402.12842}, CSD~\citep{2509.25837}, AdaKD~\citep{2510.11615}, MiniPLM~\citep{2410.17215}, MAD-OPD~\citep{wang2026madopd}}, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.2 Black-Box and API-Constrained Distillation}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{9};} Lion~\citep{2305.12870}, GAD~\citep{2511.10643}, OVD~\citep{2601.21968}, DAIL~\citep{2602.02405}, ORPO-Distill~\citep{2509.25100}, LUFFY~\citep{2504.14945}, ThinkTuning~\citep{rrv2025thinktuning}, DASD~\citep{2601.09088}, DDT~\citep{2602.12222}}, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.3 Self-Distillation: Privileged Information}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{9};} OPSD~\citep{2601.18734}, GATES~\citep{2602.20574}, Priv. Info. Distill~\citep{2602.04942}, OPCD~\citep{2602.12275}, OEL~\citep{2603.16856}, HDPO~\citep{2603.23871}, CRISP~\citep{2603.05433}, OPSDL~\citep{2604.17535}, GUI-SD~\citep{zhang2026guisd}}, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.4 Self-Distillation: Self-Play}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{7};} SPIN~\citep{2401.01335}, MTP Self-Distill~\citep{2602.06019}, SDFT~\citep{2601.19897}, On-Policy SFT~\citep{zhao2026onpolicy}, SSD~\citep{zhang2026embarrassingly}, $\pi$-Play~\citep{zhang2026piplay}, IRIS~\citep{2604.20933}}, leaf=sdcolor, edge={draw=sdcolor!30}]
      [{\textbf{5.5 Self-Distillation: External Feedback}~{\tikz[baseline=-0.5ex]\node[badge=sdcolor]{7};} SDPO~\citep{2601.20802}, SD-ZERO~\citep{he2026selfdistillation}, RLSD~\citep{yang2026selfdistilled}, SRPO~\citep{li2026unifying}, RLTF~\citep{song2026expanding}, CoPD~\citep{gu2026copd}, MSD~\citep{qin2026msd}}, leaf=sdcolor, edge={draw=sdcolor!30}]
    ]
    ...
    [{\S 6 Training Dynamics and Efficiency}, catDyn, edge={draw=dycolor!60, line width=1.2pt}
      [{\textbf{6.1 Token and Sample Weighting}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{4};} TIP~\citep{xu2026tip}, SCOPE~\citep{zheng2026scope}, SelecTKD~\citep{2510.24021}, AdaSwitch~\citep{2510.07842}}, leaf=dycolor, edge={draw=dycolor!30}]
      [{\textbf{6.2 Curriculum and Difficulty Adaptation}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{8};} PACED~\citep{2603.11178}, Stable-OPD~\citep{luo2026demystifying}, SSB~\citep{mitra2025semantic}, PAINT~\citep{wang2026paint}, PRISM~\citep{wang2026prism}, CaOPD~\citep{2604.16830}, TCOD~\citep{chen2026tcod}, Uni-OPD~\citep{arxiv2605_03677}}, leaf=dycolor, edge={draw=dycolor!30}]
      [{\textbf{6.3 Compute Optimization}~{\tikz[baseline=-0.5ex]\node[badge=dycolor]{3};} Fast OPD~\citep{2602.15260}, Lightning OPD~\citep{wu2026lightning}, Speculative KD~\citep{2410.11325}}, leaf=dycolor, edge={draw=dycolor!30}]
    ]
  ]
\end{forest}
}
\caption{Taxonomy of On-Policy Distillation methods organized by the practitioner's decision chain: (1) Objective function design (\S\ref{sec:objectives}), (2) Signal source and teacher architecture (\S\ref{sec:signal}), and (3) Training dynamics and efficiency (\S\ref{sec:dynamics}). Each leaf lists the representative methods in that subsection; the badge shows the method count. Methods that contribute to multiple dimensions are placed under their most distinctive contribution.}
\label{fig:taxonomy}
\end{figure*}
...
ToDi~\citep{2505.16297} operationalizes this insight through per-token weighting derived from the teacher-student probability log-ratio. A sigmoid-based function $w_t = \sigma(\log p_T(y_t|y_{<t}) - \log p_\theta(y_t|y_{<t}))$ dynamically blends Forward KL and Reverse KL for each token:
\begin{equation}
...
OPD requires generating student rollouts \emph{and} scoring them with the teacher at every training step, creating substantial compute overhead relative to off-policy SFT. Several methods target this bottleneck.
...
\begin{enumerate}[nosep]
    ...
    \item \textit{Pass rate on target prompts}: If the student cannot solve any problems in the target domain, OPD gradients will vanish. Use curriculum (PACED) or easier warm-up tasks.
...
MAD-OPD~\citep{wang2026madopd} pushes the multi-teacher paradigm further by recasting the distillation teacher as a \emph{deliberative collective}: multiple teacher models debate over the student's on-policy state, and the debate process produces an emergent collective intelligence that surpasses any individual teacher's capability ceiling. Rather than naively averaging teacher logits (which dilutes each teacher's expertise), MAD-OPD weights each teacher's contribution by its post-debate confidence, ensuring that the most knowledgeable teacher dominates at each token position. This confidence-weighted ensemble produces token-level supervision that transcends the single-teacher capability ceiling: when one teacher errs, the debate process concentrates weight on teachers that provide more coherent continuations. For agentic tasks where per-step errors compound across long trajectories, MAD-OPD introduces On-Policy Agentic Distillation (OPAD), which adds step-level sampling to stabilize training under multi-step error compounding. The method also derives a task-adaptive divergence principle: JSD for agentic stability (where bounded gradients prevent catastrophic policy swings) and Reverse KL for code generation (where mode-seeking preserves syntactic coherence). Across six teacher-student configurations spanning Qwen3 and Qwen3.5 (1.7B to 14B students, 8B to 32B teachers), MAD-OPD ranks first on all configurations; on the representative 14B+8B$\to$4B setting, it lifts the agentic average by $+2.4\%$ and code average by $+3.7\%$ over the stronger single-teacher OPD baseline. This result confirms that the single-teacher ceiling identified by~\citet{li2026rethinking} is not a fundamental limitation of OPD but rather an artifact of single-source supervision.
...
\begin{table*}[t]
    ...
    \begin{tabular}{@{}lllll@{}}
        ...
        MSD \citep{qin2026msd} & Self (English CoT PI) & Qwen2.5-7B, Llama-3.1-8B & DPSW cross-lingual distill & Multilingual Safety \\
        \midrule
...
\end{equation}
where the audio mode generates on-policy rollouts and the text mode provides token-level targets through Reverse KL, combined with GRPO for outcome reward maximization. CORD achieves state-of-the-art speech reasoning performance, demonstrating that different modality modes of the same model can serve as effective mutual teachers through on-policy interaction.
...
\begin{enumerate}
    ...
    \item \textbf{Reward-guided refinement} (final smaller share): RL-augmented objectives (G-OPD, KDRL, RLAD) push the student beyond the teacher's capability ceiling on reasoning tasks, using sparse outcome rewards to discover novel solution paths.
\end{enumerate}
...
On the safety front, OPD introduces both risks and mitigations. The risk is that effective distillation of frontier capabilities lowers barriers to misuse. The mitigation is that the teacher retains a supervisory role during training, providing a natural point for injecting safety constraints, alignment objectives, and capability boundaries. MSD~\citep{qin2026msd} provides a concrete instantiation of safety-aware OPD: by using the same model's English-prompted reasoning as a teacher for its low-resource-language student, MSD transfers safety alignment from high-resource to low-resource languages through on-policy self-distillation without requiring any target-language safety data. Its Dual-Perspective Safety Weighting (DPSW) adaptively upweights safety-critical tokens by combining teacher confidence (high when the teacher recognizes a safety boundary) with student disagreement (high when the student would produce an unsafe response), concentrating the distillation gradient precisely on tokens that determine whether a response is safe or harmful. The result generalizes to unseen languages and more challenging jailbreak attacks, demonstrating that OPD can serve as a scalable mechanism for multilingual safety alignment. As the field matures, we expect safety-aware OPD, where the teacher not only transfers knowledge but also enforces alignment properties during the interactive training loop, to become a critical research direction.
