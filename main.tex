...
\begin{forest}
  ...
  [\textbf{On-Policy Distillation}, rbox, text width=2.8cm
    [{Feedback Signal}, dimA, edge={draw=dimteal!60, line width=1.2pt}
      [{\textbf{Logit-Based} \textbullet~\textit{GKD, MiniLLM, DistiLLM, DistiLLM-2, DSKD, Entropy-Aware, CSD, Fast OPD,} \\ \textit{$\mathcal{X}$-KD, G-OPD, REOPOLD, TSD-KD, PACED, KETCHUP, DASD, DDT, Veto}}, leaf=dimteal, edge={draw=dimteal!30}]
    ...
    [{Teacher Access}, dimB, edge={draw=dimviolet!60, line width=1.2pt}
      [{\textbf{White-Box} \textbullet~\textit{GKD, MiniLLM, DistiLLM, DistiLLM-2, PACED, Fast OPD, Entropy-Aware,} \\ \textit{DSKD, REOPOLD, TSD-KD, DASD, $\mathcal{X}$-KD, AdaSwitch, Constrained, KETCHUP, CSD, G-OPD, Veto}}, leaf=dimviolet, edge={draw=dimviolet!30}]
