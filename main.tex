...
Orthogonal to the choice o$f$-divergence is the question of \emph{which tokens matter most}. Standard OPD objectives treat all positions uniformly, ignoring that some tokens (reasoning steps, rare vocabulary) carry far more information than others (articles, punctuation).
...
The theoretical landscape of white-box OPD centers on the geometry o$f$-divergence functions in high-dimensional probability spaces. We synthesize the key analytical results and their practical implications.
